...
export class UserService {
  ...
  async getInfo(id: number) {
    ...
    rolePages.forEach(rolePage => {
      if(rolePage.rolePage_create) permissions.push(`${rolePage.page_name}:create`)
      if(rolePage.rolePage_retrieve) permissions.push(`${rolePage.page_name}:retrieve`)
      if(rolePage.rolePage_update) permissions.push(`${rolePage.page_name}:update`)
      if(rolePage.rolePage_delete) permissions.push(`${rolePage.page_name}:delete`)
    })
